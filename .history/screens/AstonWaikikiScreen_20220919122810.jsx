...
{/* PropTypes removal workaround */}
          <ScrollView>
            <View>
                <ScrollView horizontal={true} style={{flexDirection: "row", marginTop: 40}} showsHorizontalScrollIndicator={false}>
          ...
          <View style={{padding: 20, marginTop: -50, marginBottom: 40 }}>
