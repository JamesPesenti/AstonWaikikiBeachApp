          ...
          <ScrollView>
                <View>
                    <ScrollView horizontal={true} style={{flexDirection: "row", marginTop: 60, marginBottom: 20,}} showsHorizontalScrollIndicator={false}>
                        ...
                        <Image style={{flexDirection: "row", width: 250, height: 275, borderRadius: 30, marginTop: 5, margin: 2}} source={{uri:("https://cdn.traveltripper.io/site-assets/192_884_15226/media/2018-05-02-031912/medium_Tiki_s-Night.jpg")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 275, borderRadius: 30, marginTop: 5, margin: 2}} source={{uri:("https://wpcdn.us-midwest-1.vip.tn-cloud.net/www.honolulumagazine.com/content/uploads/data-import/26919ffc/splash_tiki.jpg")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 275, borderRadius: 30, marginTop: 5, margin: 2}} source={{uri: ("https://cf.bstatic.com/xdata/images/hotel/max1280x900/255722955.jpg?k=9e645bd92628a3e116e9462ec0bf89ce531b25b65eb2033e09993915523e6ba2&o=&hp=1")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 275, borderRadius: 30, marginTop: 5, margin: 2}} source={{uri:("https://cf.bstatic.com/xdata/images/hotel/max1280x900/255722965.jpg?k=7e9f9cc786433cc6c4771427bcbead1c970a74d549b6222758fce4b2e11e2aab&o=&hp=1")}} />
                    </ScrollView>
                </View>
            </ScrollView>
          </View>
