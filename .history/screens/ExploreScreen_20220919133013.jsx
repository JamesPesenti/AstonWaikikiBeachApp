...
function ExploreScreen() {
  ...
  <ScrollView>
   ...
   <View style={styles.doleCard}>
     <Image style={{ marginTop: -80, resizeMode: "cover", borderRadius: 15, width: "100%", height: 220}} source={{uri: "http://www.onlyinyourstate.com/wp-content/uploads/2017/07/3753439312_3cd37698de_b.jpg"}}/>
