          ...
          <ScrollView>
                <View>
                    <ScrollView horizontal={true} style={{flexDirection: "row", marginTop: 60, marginBottom: 20,}} showsHorizontalScrollIndicator={false}>
                        <Image style={{flexDirection: "row", width: 250, height: 275, borderRadius: 30, marginTop: 5, margin: 2}} source={{uri: ("https://res.cloudinary.com/traveltripperweb/image/upload/c_fit,f_auto,h_992,q_auto,w_992/v1603155222/amjkch5zqyazksjcldpb.jpg")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 275, borderRadius: 30, marginTop: 5, margin: 2}} source={{uri:("https://res.cloudinary.com/traveltripperweb/image/upload/c_fit,f_auto,h_992,q_auto,w_992/v1603155424/dadlnqygqy3crgyvzla7.jpg")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 275, borderRadius: 30, marginTop: 5, margin: 2}} source={{uri:("https://res.cloudinary.com/traveltripperweb/image/upload/c_fit,f_auto,h_992,q_auto,w_992/v1603155220/lc3yidopumdxnouxb5kt.jpg")}} />
