...
function ExploreScreen() {
  ...
  <ScrollView>
   ...
   <View style={styles.polyCard}>
     <Image style={{ marginTop: 0, resizeMode: "cover", borderRadius: 15, width: "100%", height: 200}} source={{uri: "https://www.gohawaii.cn/sites/default/files/styles/image_gallery_bg_xl/public/hero-unit-images/polynesian-cultural-center_lg.jpg?itok=W0JR5XPu"}}/>
