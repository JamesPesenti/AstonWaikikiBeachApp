...
function ExploreScreen() {
  ...
  <ScrollView>
   ...
   <View style={styles.lanikaiCard}>
     <Image style={{ marginTop: -80, resizeMode: "cover", borderRadius: 15, width: "100%", height: 260}} source={{uri: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/f4/fc/a6/caption.jpg?w=500&h=400&s=1"}}/>
