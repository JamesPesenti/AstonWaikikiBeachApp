...
function ExploreScreen() {
  ...
  <ScrollView>
   ...
   <View style={styles.kualoaCard}>
     <Image style={{ marginTop: -40, resizeMode: "cover", borderRadius: 20, width: "100%", height: 220}} source={{uri: "https://thegoldenhouradventurer.com/wp-content/uploads/2021/03/Jurassic-Park-1.jpg"}}/>
