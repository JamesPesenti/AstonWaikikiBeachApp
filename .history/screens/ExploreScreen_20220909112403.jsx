  ...
  <ScrollView>
      ...
      <View style={styles.container}>
        <View style={styles.diamondCard}>
          <Image style={{ marginTop: -25, resizeMode: "contain", borderRadius: 25, width: "100%", height: 280}} source={{uri: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSVyu4giIdqp6KtIvxfI88adMh_ITNuqb2dCOKyPIoLaNodVAGGqG4PSJQD98ROQUZm0leVFoBBYCV7t5AwyvyN1g"}}/>
      ...
      <View style={styles.hanaumaCard}>
          <Image style={{ marginTop: -30, resizeMode: "contain", borderRadius: 15, width: "100%", height: 220}} source={{uri: "https://cdn.shortpixel.ai/spai/q_lossy+ret_img+to_webp/https://xdaysiny.com/wp-content/uploads/2017/07/Hanauma-Bay-Oahu-Hawaii.jpg"}}/>
   ...
   <View style={styles.lanikaiCard}>
     <Image style={{ marginTop: -80, resizeMode: "contain", borderRadius: 15, width: "100%", height: 300}} source={{uri: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/f4/fc/a6/caption.jpg?w=500&h=400&s=1"}}/>
   ...
   <View style={styles.kualoaCard}>
     <Image style={{ marginTop: -40, resizeMode: "contain", borderRadius: 20, width: "100%", height: 240}} source={{uri: "https://thegoldenhouradventurer.com/wp-content/uploads/2021/03/Jurassic-Park-1.jpg"}}/>
   ...
   <View style={styles.doleCard}>
     <Image style={{ marginTop: -80, resizeMode: "cover", borderRadius: 15, width: "100%", height: 250}} source={{uri: "http://www.onlyinyourstate.com/wp-content/uploads/2017/07/3753439312_3cd37698de_b.jpg"}}/>
   ...
   <View style={styles.polyCard}>
     <Image style={{ marginTop: -80, resizeMode: "contain", borderRadius: 15, width: "100%", height: 230}} source={{uri: "https://www.gohawaii.cn/sites/default/files/styles/image_gallery_bg_xl/public/hero-unit-images/polynesian-cultural-center_lg.jpg?itok=W0JR5XPu"}}/>
