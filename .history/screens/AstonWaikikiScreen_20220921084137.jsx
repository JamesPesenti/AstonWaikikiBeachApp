  ...
  return (
    ...
    <ScrollView>
        ...
        <View style={styles.overlayView} />
            ...
            <ScrollView>
                    <View>
                        <ScrollView horizontal={true} style={{flexDirection: "row", marginTop: 60, marginBottom: 40,}} showsHorizontalScrollIndicator={false}>
                            <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 5, margin: 0}} source={{uri: ("https://res.cloudinary.com/traveltripperweb/image/upload/c_fit,h_992,w_992/v1565988929/f54za00nzoikhcn3j8b5.jpg")}} />
                            <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 5, margin: 0}} source={{uri:("https://res.cloudinary.com/traveltripperweb/image/upload/c_fit,h_992,w_992/v1571801323/h5tybnvkv2eabxhyenno.jpg")}} />
          ...
          <Text style={styles.poolHeader}>Pool Area & Amenities</Text>
          ...
          <ScrollView>
                <View>
                    <ScrollView horizontal={true} style={{flexDirection: "row", marginTop: 60, marginBottom: 20,}} showsHorizontalScrollIndicator={false}>
                        <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 5, margin: 5}} source={{uri: ("https://res.cloudinary.com/traveltripperweb/image/upload/c_fit,f_auto,h_992,q_auto,w_992/v1603155222/amjkch5zqyazksjcldpb.jpg")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 5, margin: 5}} source={{uri:("https://res.cloudinary.com/traveltripperweb/image/upload/c_fit,f_auto,h_992,q_auto,w_992/v1603155424/dadlnqygqy3crgyvzla7.jpg")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 5, margin: 5}} source={{uri:("https://res.cloudinary.com/traveltripperweb/image/upload/c_fit,f_auto,h_992,q_auto,w_992/v1603155220/lc3yidopumdxnouxb5kt.jpg")}} />

                        <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 5, margin: 5}} source={{uri:("https://cdn.traveltripper.io/site-assets/192_884_15226/media/2018-05-02-031912/medium_Tiki_s-Night.jpg")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 5, margin: 5,}} source={{uri:("https://wpcdn.us-midwest-1.vip.tn-cloud.net/www.honolulumagazine.com/content/uploads/data-import/26919ffc/splash_tiki.jpg")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 5, margin: 5}} source={{uri: ("https://cf.bstatic.com/xdata/images/hotel/max1280x900/255722955.jpg?k=9e645bd92628a3e116e9462ec0bf89ce531b25b65eb2033e09993915523e6ba2&o=&hp=1")}} />
                        <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 5, margin: 5}} source={{uri:("https://cf.bstatic.com/xdata/images/hotel/max1280x900/255722965.jpg?k=7e9f9cc786433cc6c4771427bcbead1c970a74d549b6222758fce4b2e11e2aab&o=&hp=1")}} />
                    </ScrollView>
                </View>
            </ScrollView>
          </View>
