            ...
            <ScrollView>
                    <View>
                        <ScrollView horizontal={true} style={{flexDirection: "row", marginTop: 60, marginBottom: 40,}} showsHorizontalScrollIndicator={false}>
                            <Image style={{flexDirection: "row", width: 260, height: 285, borderRadius: 30, marginTop: 5, margin: 5}} source={{uri: ("https://res.cloudinary.com/traveltripperweb/image/upload/c_fit,h_992,w_992/v1565988929/f54za00nzoikhcn3j8b5.jpg")}} />
