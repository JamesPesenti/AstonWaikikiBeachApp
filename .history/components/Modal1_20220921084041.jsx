    ...
    <ScrollView>
      <View style={styles.centeredView}>
        ...
        <ScrollView style={{marginTop: 5, paddingBottom: -100}} horizontal={true} showsHorizontalScrollIndicator={false}>
          <Image style={{flexDirection: "row", width: 250, height: 285, borderRadius: 30, marginTop: 0, margin: 5}} source={{uri: ("https://i.pinimg.com/originals/c1/6d/05/c16d0572ebc8158765c56edfa4e4f120.jpg")}} />
